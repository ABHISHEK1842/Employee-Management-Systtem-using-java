...
public class Home extends JFrame implements ActionListener{
    ...
    JButton view, add, update, remove , contacts ,Feedback;
    ...
    Home() {
        ...
        contacts = new JButton("Contact id");
        contacts.setBounds(650, 200, 150, 40);
        contacts.addActionListener(this);
        image.add(contacts);
        
        Feedback = new JButton("Feedback Employee");
